...
var NAME = 'step-progress';
var StepProgressComponent = (function () {
    function StepProgressComponent() {
    }
    __decorate([
        core_1.Input(), 
        __metadata('design:type', models_1.Bundle)
    ], StepProgressComponent.prototype, "bundle", void 0);
    StepProgressComponent = __decorate([
        core_1.Component({
...
exports.StepProgressComponent = StepProgressComponent;
