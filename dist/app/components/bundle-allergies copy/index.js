...
var BundleAllergiesComponent = (function () {
    ...
    BundleAllergiesComponent.prototype.allergyTitle = function (allergyId) {
        return _.find(models_1.allergyDefs, { id: allergyId }).title;
    };
    BundleAllergiesComponent.prototype.allergyPrice = function (allergyId) {
        return _.find(models_1.allergyDefs, { id: allergyId }).price;
    };
    Object.defineProperty(BundleAllergiesComponent.prototype, "bundle", {
        set: function (bundle) {
            this.b = bundle;
        },
        enumerable: true,
